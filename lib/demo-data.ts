...
export const demoQuartiers: Quartier[] = [
  ...
  { id: 25, name: "Yaoundé 1er", is_active: true, travel_fee: 0 },
  { id: 26, name: "Yaoundé 2e", is_active: true, travel_fee: 0 },
  { id: 27, name: "Yaoundé 3e", is_active: true, travel_fee: 0 },
  { id: 28, name: "Yaoundé 4e", is_active: true, travel_fee: 0 },
  { id: 29, name: "Yaoundé 5e", is_active: true, travel_fee: 0 },
  { id: 30, name: "Yaoundé 6e", is_active: true, travel_fee: 0 },
  { id: 31, name: "Yaoundé 7e", is_active: true, travel_fee: 0 },
  { id: 32, name: "Bafoussam", is_active: true, travel_fee: 0 },
]
...
export const demoReviews: AgentReviewPublic[] = [
  ...
  },
  {
    id: "r5",
    agent_id: "a4",
    client_first_name: "Bernadette",
    rating: 5,
    comment: "Enfin une plateforme sérieuse. J'ai pu vérifier son profil avant même de la rencontrer.",
    published_at: "2026-06-18",
  },
  {
    id: "r6",
    agent_id: "a5",
    client_first_name: "Christelle",
    rating: 5,
    comment: "Elle s'occupe de mon bébé comme si c'était le sien. Aucun souci en 4 mois.",
    published_at: "2026-05-29",
  },
  {
    id: "r7",
    agent_id: "a6",
    client_first_name: "M. Njike",
    rating: 4,
    comment: "Bonne prestation, ponctuel. Le paiement par MoMo simplifie vraiment les choses.",
    published_at: "2026-04-15",
  },
  {
    id: "r8",
    agent_id: "a7",
    client_first_name: "Odile",
    rating: 5,
    comment: "Le processus de réservation est simple et j'ai reçu un reçu digital immédiatement.",
    published_at: "2026-06-25",
  },
  {
    id: "r9",
    agent_id: "a2",
    client_first_name: "Serge",
    rating: 5,
    comment: "On voit qu'elle est vraiment vérifiée — références sérieuses, très rassurant pour nous.",
    published_at: "2026-03-08",
  },
  {
    id: "r10",
    agent_id: "a4",
    client_first_name: "Fabiola",
    rating: 4,
    comment: "Très bon suivi de KONEXA après le placement, réactifs en cas de question.",
